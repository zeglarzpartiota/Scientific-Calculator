...
class Calculator:
    ...
    def euler2(self):
        self.current_value = float(math.e ** float(self.current_value))
        display(self.current_value)
    ...
    def arcSine(self):
        self.current_value = math.asin(float(self.current_value))
        display(self.current_value)

    def arcCosine(self):
        self.current_value = math.acos(float(self.current_value))
        display(self.current_value)

    def arcTangent(self):
        self.current_value = math.atan(float(self.current_value))
        display(self.current_value)

    def hyperbolicArcSine(self):
        self.current_value = math.asinh(float(self.current_value))
        display(self.current_value)

    def hyperbolicArcCosine(self):
        self.current_value = math.acosh(float(self.current_value))
        display(self.current_value)

    def hyperbolicArcTangent(self):
        self.current_value = math.atanh(float(self.current_value))
        display(self.current_value)

    def exponentiation(self):
        self.current_value = float(self.current_value) ** 2
        display(self.current_value)

    def log(self):
        self.current_value = math.log2(float(self.current_value))
        display(self.current_value)

    def root(self):
        self.current_value = math.sqrt(float(self.current_value))
        display(self.current_value)
...
buttonExponentiation2 = Button(
    ...
    activebackground='#808080',
    font=('Helvetica', 20, 'bold'),
    command=lambda: calculator.exponentiation()
...
buttonRoot2 = Button(
    ...
    activebackground='#808080',
    font=('Helvetica', 20, 'bold'),
    command=lambda: calculator.root()
...
buttonTangent = Button(
    ...
    activebackground='#808080',
    font=('Helvetica', 20, 'bold'),
    command=lambda: calculator.tangent()
...
buttonEuler = Button(
    ...
    activebackground='#808080',
    font=('Helvetica', 20, 'bold'),
    command=lambda: calculator.euler()
).grid(row=4, column=4, pady=1)

buttonArcSine = Button(
    calc,
    text='asin',
    width=6,
    height=2,
    ...
    activebackground='#808080',
    font=('Helvetica', 20, 'bold'),
    command=lambda: calculator.arcSine()
).grid(row=4, column=5, pady=1)

buttonArcCosine = Button(
    calc,
    text='acos',
    width=6,
    height=2,
    ...
    activebackground='#808080',
    font=('Helvetica', 20, 'bold'),
    command=lambda: calculator.arcCosine()
).grid(row=4, column=6, pady=1)

buttonArcTangent = Button(
    calc,
    text='atan',
    width=6,
    height=2,
    ...
    activebackground='#808080',
    font=('Helvetica', 20, 'bold'),
    command=lambda: calculator.arcTangent()
...
buttonEuler2 = Button(
    ...
    bg='#505050',
    activebackground='#808080',
    command=lambda: calculator.euler2(),
    font=('Helvetica', 20, 'bold')
).grid(row=5, column=4, pady=1)

buttonHyperbolicArcSine = Button(
    calc,
    text='asinh',
    width=6,
    height=2,
    ...
    activebackground='#808080',
    font=('Helvetica', 20, 'bold'),
    command=lambda: calculator.hyperbolicArcSine()
).grid(row=5, column=5, pady=1)

buttonHyperbolicArcCosine = Button(
    calc,
    text='acosh',
    width=6,
    height=2,
    ...
    activebackground='#808080',
    font=('Helvetica', 20, 'bold'),
    command=lambda: calculator.hyperbolicArcCosine()
).grid(row=5, column=6, pady=1)

buttonHyperbolicArcTangent = Button(
    calc,
    text='atanh',
    width=6,
    height=2,
    ...
    activebackground='#808080',
    font=('Helvetica', 20, 'bold'),
    command=lambda: calculator.hyperbolicArcTangent()
